...
This repository contains the `.proto` files used by the Astarte message hub as well as by any client
that wishes to connect itself to the message hub.
...
generated. Since different languages may use different gRPC implementations and protobuf compilers
here is a table with the used versions.
