...
class MessageHubStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetProperty = channel.unary_unary(
                ...
                response_deserializer=astarteplatform_dot_msghub_dot_property__pb2.OptionalProperty.FromString,
                _registered_method=True)
...
def add_MessageHubServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetProperty': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=astarteplatform_dot_msghub_dot_property__pb2.OptionalProperty.SerializeToString,
            ),
    }
...
class MessageHub(object):
    ...
    def GetProperty(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            astarteplatform_dot_msghub_dot_property__pb2.OptionalProperty.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
