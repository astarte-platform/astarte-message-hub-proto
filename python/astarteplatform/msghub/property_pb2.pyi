...
class Property(_message.Message):
    ...
    path: str
    value: _astarte_type_pb2.AstarteDataTypeIndividual
    def __init__(self, path: _Optional[str] = ..., value: _Optional[_Union[_astarte_type_pb2.AstarteDataTypeIndividual, _Mapping]] = ...) -> None: ...

class OptionalProperty(_message.Message):
    __slots__ = ("path", "value")
    PATH_FIELD_NUMBER: _ClassVar[int]
    VALUE_FIELD_NUMBER: _ClassVar[int]
    path: str
