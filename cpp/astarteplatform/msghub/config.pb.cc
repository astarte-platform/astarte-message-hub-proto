...
inline void ConfigMessage::SharedDtor() {
  ...
  _impl_.credentials_secret_.Destroy();
  _impl_.pairing_url_.Destroy();
  _impl_.pairing_token_.Destroy();
  _impl_.grpc_socket_host_.Destroy();
  _impl_.~Impl_();
}

const ::google::protobuf::MessageLite::ClassData*
ConfigMessage::GetClassData() const {
...
::uint8_t* ConfigMessage::_InternalSerialize(
  ...
  // optional string credentials_secret = 3;
  if (cached_has_bits & 0x00000002u) {
    const std::string& _s = this->_internal_credentials_secret();
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
  ...
  // string pairing_url = 4;
  if (!this->_internal_pairing_url().empty()) {
    const std::string& _s = this->_internal_pairing_url();
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
  ...
  // optional string pairing_token = 5;
  if (cached_has_bits & 0x00000004u) {
    const std::string& _s = this->_internal_pairing_token();
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
  ...
  if (cached_has_bits & 0x00000010u) {
    ...
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(
        6, this->_internal_grpc_socket_port(), target);
  }

  // optional string grpc_socket_host = 7;
  if (cached_has_bits & 0x00000008u) {
    const std::string& _s = this->_internal_grpc_socket_host();
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
...
// @@protoc_insertion_point(message_byte_size_start:astarteplatform.msghub.ConfigMessage)
  ...
  if (cached_has_bits & 0x00000003u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      total_size += 1 + ::google::protobuf::internal::WireFormatLite::StringSize(
                                      this->_internal_credentials_secret());
    }
  ...
  if (cached_has_bits & 0x0000001cu) {
    ...
    if (cached_has_bits & 0x00000004u) {
      total_size += 1 + ::google::protobuf::internal::WireFormatLite::StringSize(
                                      this->_internal_pairing_token());
    }

    // optional string grpc_socket_host = 7;
    if (cached_has_bits & 0x00000008u) {
      total_size += 1 + ::google::protobuf::internal::WireFormatLite::StringSize(
                                      this->_internal_grpc_socket_host());
    }

    // optional uint32 grpc_socket_port = 6;
    if (cached_has_bits & 0x00000010u) {
      total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(
          this->_internal_grpc_socket_port());
    }
